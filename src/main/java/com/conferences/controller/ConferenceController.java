...
import com.conferences.utils.PaginationUtil;
...
public class ConferenceController {
    ...
    @Autowired
    public ConferenceController(ConferenceService service, ConferenceRepository repository) {
    ...
    public ResponseEntity<Conference> createConference(@RequestBody ConferenceDTO conferenceDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/conference/create" + conferenceDTO.getTitle()))
              .headers(headers)
